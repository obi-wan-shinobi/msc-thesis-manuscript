...
on the unit circle \(S^1\). In the infinite-width limit, the NTK defines a
deterministic integral operator. For the uniform distribution on the circle,
this operator is diagonalized by the Fourier basis. This gives a clean
reference picture for spectral bias: each Fourier mode has its own learning
rate. The rest of the thesis studies how this picture changes at finite sample
