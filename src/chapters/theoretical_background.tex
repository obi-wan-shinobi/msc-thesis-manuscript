...
\begin{equation}
	...
	\frac{1}{\sqrt{m}}
	\sum_{\alpha=1}^m
	v_\alpha\,\varphi(w_\alpha^\top x + b_\alpha),
	\qquad
	v_\alpha, b_\alpha \in \mathbb{R}, \quad w_\alpha, x \in \mathbb{R}^d.
	\label{eq:1hl-network}
\end{equation}
Each neuron is parameterized by $\theta_\alpha = (v_\alpha,w_\alpha,b_\alpha)$ and
...
\[
	...
	\qquad
	b_\alpha \sim \mathcal{N}(0,\sigma_b^2),
\]
...
\begin{align}
	\nabla_{v_\alpha} f(x)
	 & = \frac{1}{\sqrt{m}}\varphi(w_\alpha^\top x + b_\alpha),                 \\
	\nabla_{w_\alpha} f(x)
	 & = \frac{1}{\sqrt{m}}\,v_\alpha\,\varphi'(w_\alpha^\top x + b_\alpha)\,x, \\
	\nabla_{b_\alpha} f(x)
	 & = \frac{1}{\sqrt{m}}\,v_\alpha\,\varphi'(w_\alpha^\top x + b_\alpha).
\end{align}
...
\begin{equation}
	...
	\varphi(w_\alpha^\top x + b_\alpha)\,\varphi(w_\alpha^\top x' + b_\alpha)
	+
	\frac{1}{m}\sum_{\alpha=1}^m
	v_\alpha^2\,
	\varphi'(w_\alpha^\top x + b_\alpha)\,
	\varphi'(w_\alpha^\top x' + b_\alpha)\,
	\bigl(x^\top x' + 1\bigr).
...
\begin{equation}
	\bar\Theta(x,x')
	=
	\mathbb{E}_{w,b}\!\big[\varphi(w^\top x + b)\,\varphi(w^\top x' + b)\big]
	+
	\sigma_v^2\,\bigl(x^\top x' + 1\bigr)\,
	\mathbb{E}_{w,b}\!\big[\varphi'(w^\top x + b)\,\varphi'(w^\top x' + b)\big].
...
reduce to a linear iteration in prediction space. Equation~\eqref{eq:ntk-constant-kernel},
