...
\section{Overview and relation to the NTK viewpoint}\label{app:mf-overview}
...
\section{Detailed derivation of the mean-field representation}\label{app:mf-detailed}

\subsection{Parameter space and empirical measure}\label{app:mf-empirical-measure}
...
\subsection{Initialization and weak convergence}\label{app:mf-weak-convergence}
...
\subsection{Training dynamics and evolution of the empirical measure}\label{app:mf-particle-dynamics}
...
\subsection{Continuity equation and push-forward formulation}\label{app:mf-continuity-equation}
...
\section{Comparison with the NTK scaling}\label{app:mf-comparison-ntk}
