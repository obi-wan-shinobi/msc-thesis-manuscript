...
\coverpicture{\makebox[\textwidth]{\includegraphics[width=0.92\textwidth, trim=40 109 38 48, clip]{../img/cover}}}


% A copyright notice and maybe something about the cover picture
% Put in comments to get the default copyright notice
\colophon{\noindent\copyright{} \the\year{} \theauthor. All rights reserved. Cover illustration generated with OpenAI's ChatGPT image-generation tool and subsequently edited manually by the author. }
...
\committeemember{Prof. Dr. A. Papapantoleon, DIAM, Faculty EEMCS, TU Delft}
...
\include{frontmatter/acknowledgements} \include{frontmatter/notation}
...
\include{chapters/discussion_conclusion_and_futurework}
\include{chapters/use_of_generative_ai}
